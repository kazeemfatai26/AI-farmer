  ...
  setFarmers((prevFarmers) => [...prevFarmers, newFarmer]);
    ...
    return(
        <div className="flex min-h-screen bg-gray-50">
            ...
            {/*Sidebar*/}
            <aside className={`w-60 bg-white border-r border-gray-200 p-4 fixed md:static inset-y-0 left-0 z-50 transform transition-transform duration-200 ${
            sidebarOpen ? "translate-x-0" : "-translate-x-full"
                ...
                <nav>
                    <button onClick={() => {setView("list");  setSidebarOpen(false);}}
                    ...
                    <button onClick={() => {setView("add"); setSidebarOpen(false);}}
